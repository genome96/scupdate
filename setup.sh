...
echo -e "  Recoded by myself Darkanon store vpn ${YELLOW}(${NC}2024${YELLOW})${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
sleep 2
###### PERMISSION SC 
...
clear
izinsc="https://raw.githubusercontent.com/genome96/scupdate/main/register"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"Order","url":"https://wa.me/+254706376682"}]]}' 
...
wget -q https://raw.githubusercontent.com/genome96/scupdate/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
