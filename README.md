...
```
apt install screen bzip2 -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/genome96/scupdate/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
```
